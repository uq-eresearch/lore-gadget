        ...
        Ext.apply(this, { 
            ...
            tpl :  new Ext.XTemplate(               
                ...
                '<div class="coListing" onclick="lore.ore.controller.loadCompoundObjectFromURL(\'{uri}\')">',
                    ...
                    '<tpl if="lore.ore.reposAdapter && uri.match(lore.ore.reposAdapter.idPrefix)"><img src="../lore/skin/icons/oaioreicon-sm.png"></tpl>',
                    '<tpl if="lore.ore.reposAdapter && !uri.match(lore.ore.reposAdapter.idPrefix)"><img src="../lore/skin/icons/oaioreicon-grey.png"></tpl>',
