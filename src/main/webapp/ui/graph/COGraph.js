...
Ext.extend(lore.ore.ui.graph.COGraph, lore.draw2d.Workflow, {
    ...
    showEmptyMessage : function() {
        this.setBackgroundImage("../lore/skin/icons/ore/emptyco.png",false);
    },
    /** 
    ...
    onContextMenu: function(x,y) {
        ...
        if (!this.contextmenu) {
            ...
            this.contextmenu.add({
                text: "Undo",
                icon: "../lore/skin/icons/ore/arrow_undo.png",
                scope: this,
                handler: function(b){ 
                    try{
                    this.commandStack.undo();
            ...
            this.contextmenu.add({
                text: "Redo",
                icon: "../lore/skin/icons/ore/arrow_redo.png",
                scope: this,
                handler: function(b){ 
                     this.commandStack.redo();       
                }
            ...
            this.contextmenu.add({
                text: "Auto layout",
                icon: "../lore/skin/icons/ore/layout.png",
                scope: this,
            ...
            this.contextmenu.add({
                ...
                icon: "../lore/skin/icons/ore/graph_go.png",
                scope: this,
                handler: function(evt){                 
                     this.doLayout(true);   
                }
            ...
            this.contextmenu.add({
                ...
                icon: "../lore/skin/icons/ore/table_go.png",
                scope: this,
                handler: function(evt){
                    if (lore.ore.controller.checkReadOnly()){
                        return;
            ...
            this.contextmenu.add({
             ...
             this.contextmenu.add({
                text: "Reset Zoom",
                icon: "../lore/skin/icons/ore/magnifier-zoom-actual.png",
                scope: this,
                handler: function(b){ 
                    this.scale = 1.0;
                    Ext.get("drawingarea").applyStyles(
