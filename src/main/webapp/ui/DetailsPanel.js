...
lore.ore.ui.detailsCOTemplate = new Ext.XTemplate(
    ...
    '<div style="width:100%">',
        ...
        '<img src="../lore/skin/icons/ore/page_white_word.png" title="Export to MS Word"></a>',
        '</td></tr></table>',
...
lore.ore.ui.detailsResTemplate = new Ext.XTemplate(  
    ...
    '<div id="s{uri}">',
        ...
        '<td width="80"><a href="#" title="Show in graphical editor" onclick="lore.ore.ui.graphicalEditor.showResource(\'{uri}\');"><img src="../lore/skin/icons/ore/layout_pencil.png" alt="View in graphical editor"></a>',
        '&nbsp;<a href="#" title="Show in resource list" onclick="Ext.getCmp(\'remlistview\').showResource(\'{uri}\')"><img src="../lore/skin/icons/ore/table_edit.png"></a>',
        '&nbsp;<a href="#" title="Show in slideshow view" onclick="Ext.getCmp(\'newss\').showResource(\'{uri}\');"><img src="../lore/skin/icons/ore/picture_empty.png" alt="View in slideshow view"></a>',
        '&nbsp;<a href="#" title="Show in explore view" onclick="lore.ore.explorePanel.showInExploreView(\'{uri}\',\'{title}\',{representsCO});"><img src="../lore/skin/icons/ore/network.png" alt="View in explore view"></a>',
        '</td></tr></table>',
